...
| <div style="min-width:100px">Vocab</div>            | <div style="min-width:300px">Definition</div>                                                                                                                                                                                                                   | <div style="min-width:100px">Synonyms</div>     | <div style="min-width:200px">How to Use in a Sentence</div>                                                                                        |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------------------------------------------------------------------------------------------------------- |
